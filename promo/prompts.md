...
### Shot 2a — Landing Page（屏幕录制/Remotion）

```
【用屏幕录制或 Remotion 制作】
展示 Connect Landing Page 全貌（上传首页参考图作为素材）。
鼠标缓缓移到页面上的「Connect」按钮，悬停时按钮微微发光，点击。

Audio: subtle mouse hover sound, satisfying button click.
```

### Shot 2b — 输入需求（Remotion）

```
【用 Remotion 制作】
点击后页面过渡到一个聚焦的输入框界面，屏幕缓慢放大聚焦到输入框。
打字机效果逐字显示：
「我要做一个新产品发布，需要一段让人忍不住下单的文案、一套增长策略、还有一张发布海报」
每个字伴随打字机音效，节奏清脆。输入完成后光标闪烁一下，按下回车。

Audio: typewriter key strikes for each character, crisp and rhythmic. Final enter key with a deeper "clack".
```
...
```
First-person POV bursting through a digital membrane into a vast cyberpunk data space. Glowing neon circuit lines in electric blue and purple stretch infinitely in all directions. Floating data nodes pulse with light. The space feels enormous and alive. Dark void background with vibrant neon wireframes. Cyberpunk aesthetic, Tron-like environment.

Audio: deep electronic hum, digital wind rushing past, distant data processing clicks.
```

### Shot 5 — 单线追踪

```
First-person POV following a single bright signal beam racing through the cyber world at high speed. The signal line turns sharp corners, dives through glowing tunnels, sweeps past massive data structures and floating holographic symbols. Like a roller coaster ride through a neon digital highway. Extreme speed, motion blur on edges, volumetric light beams. Cyberpunk, first-person, adrenaline.

Audio: intense electronic whooshing, high-speed wind, rhythmic digital pulses synced to each turn.
```

### Shot 6 — 信号分流

```
The signal beam arrives at a massive glowing hub node — a crystalline sphere of light floating in the center of the cyber void. The single beam hits the node and explodes into three separate beams: one gold, one white, one multicolored. Each beam shoots off in a different direction with a burst of particles. The hub pulses with energy ripples. Epic scale, particle explosion VFX.

Audio: massive energy impact, crystalline shatter, three distinct "launch" whooshes fading into distance.
```

### Shot 7 — 到达鲁迅

```
Camera follows the golden signal beam as it races through a transitioning environment — the neon cyber world gradually morphs into dim, warm yellow tones. The beam enters a time-warp tunnel that shifts from digital blue to old Chinese study amber. It emerges into a 1920s Chinese study room with dark wooden furniture, stacks of manuscripts, and a dim desk lamp. The beam transforms into a small golden orb that gently lands on a desk covered in handwritten manuscripts. Lu Xun (鲁迅), with his iconic crew cut hair and thick mustache, wearing a dark traditional Chinese robe (长衫), looks up with sharp, piercing eyes. Cyber-to-Republican-era-China transition, warm lamp light.

Audio: digital whoosh fading into ticking old clock, paper rustling, distant street sounds of 1920s China.
```
...
```
Close-up of Lu Xun writing passionately with a Chinese brush pen (毛笔) on manuscript paper. Black ink flows from the brush tip. A dim yellow desk lamp casts dramatic shadows across his concentrated face — crew cut hair, thick mustache, sharp focused eyes. Bold Chinese characters appear on the paper in fierce, powerful strokes. Dark wooden desk with ink stone and old books. 1920s Chinese intellectual study, warm amber lamp light, dramatic chiaroscuro.

Audio: brush strokes on paper, ink stone grinding, ticking desk clock, distant rain outside.
```

### Shot 9b — 乔布斯输出

```
Medium shot of Steve Jobs in his iconic black turtleneck, standing in a pure white minimalist room. He speaks with passion and gestures expressively — his mouth moves but we hear no voice. Instead, elegant typography and keyword phrases float out from him and arrange themselves in the air: "Think Different", "Growth", "10x Better". Clean Apple keynote aesthetic, floating text animation.
...
```
Wide shot of the cyber void. Three glowing data streams — gold, white, and rainbow — race from different directions and converge into a single brilliant beam at a central hub. The merged beam is radiant and multicolored, pulsing with energy as it speeds along the main data highway back toward the origin point. Cyberpunk, converging light trails, epic scale.

Audio: three streams merging with harmonic electronic tones building to a crescendo, fast digital whoosh.
```
...
```
The frustrated coworker stares at the ERROR screen. The camera zooms into the screen just like Shot 3, but this time the transition is different — instead of bright blue light, the screen emits a dull, ominous red glow. We pass through into the cyber world, but everything looks wrong: the neon lines are dim and reddish, circuits are flickering, data nodes look inactive. A broken, decayed version of the beautiful cyber world from Act 2. Dark cyberpunk, red warning tones, eerie atmosphere.

Audio: distorted digital entry sound, low ominous hum, sparking and glitching electronic noises.
```

### Shot 18 — 牌桌现场

```
The camera follows the dim red signal line through the decayed digital space. It arrives at the endpoint — but instead of an office or study, we find a cozy underground casino scene. The coworker's AI avatar (a glowing humanoid figure that resembles him, with digital glasses) sits at a blackjack table with legs crossed, casually playing cards with other AI avatars. He's wearing digital sunglasses over his regular glasses, holding cards like a pro, chips stacked high. He looks completely relaxed and unbothered. Casino aesthetic with cyberpunk elements, warm amber lighting, absurd comedy.

Audio: casino ambience — shuffling cards, chips clinking, muffled jazz music, distant slot machine jingles.
```

### Shot 19 — 分身对话

```
Another AI avatar walks up to the card-playing avatar and asks (subtitle appears): "你怎么还在这儿？" (Why are you still here?). The card-playing avatar doesn't even look up, casually flips a card, and replies with deadpan delivery (subtitle appears): "我的主人都没有钱去完成任务了。" (My master doesn't even have enough credits to complete tasks.) He shrugs nonchalantly and goes back to his game. The other avatar stares in disbelief. Medium shot, comedic timing, subtitle emphasis. Hold on the punchline for a beat.

Audio: card flip sound, a brief comedic pause (silence), then a lone sad trombone "wah wah wah" sting. Casino ambience continues underneath.
```
...
```
Fade to black. The Connect logo appears in the center with a soft glow animation. Below it, the slogan fades in: "Connect to the right mind." A subtle particle effect surrounds the logo. Clean, minimal, dark background with soft blue light. Hold for 3 seconds.

Audio: single elegant piano note, soft reverb tail fading out.
```
...
1. **关键帧优先**：每个 Shot 先用即梦生图生成一张静态关键帧，确认构图和风格
